...
describe('isDefined', () => {
  ...
  it('should return false when passed undefined or null', () => {
    [null, undefined].forEach(v => expect(isDefined(v)).toBeFalse());
  });
...
describe('isNull', () => {
  ...
  it('should return true when passed null', () => {
    [null].forEach(v => expect(isNull(v)).toBeTrue());
  });
...
describe('isPrimitive', () => {
  ...
  it('should return true when passed a primitve value', () => {
    [null, undefined, true, false, 1, 0, -20, 4.56, '', 'foo', Symbol('foo')].forEach(v =>
      expect(isPrimitive(v)).toBeTrue()
    );
  });
  it('should return false when passed anything else', () => {
    [[], [null], ['abc', 9, undefined], {}, { id: 4 }, () => {}, Math.min, Date, /^.c+$/g, class {}].forEach(v =>
      expect(isPrimitive(v)).toBeFalse()
    );
  });
});
describe('isBoolean', () => {
  ...
  it('should return true when passed a boolean', () => {
    [true, false].forEach(v => expect(isBoolean(v)).toBeTrue());
  });
  it('should return false when passed anything else', () => {
    [
      null,
...
describe('isAnyString', () => {
  ...
  it('should return true when passed a string (including empty string)', () => {
    ['foo', ''].forEach(v => expect(isAnyString(v)).toBeTrue());
  });
  it('should return false when passed anything else', () => {
    [
      null,
...
describe('isString', () => {
  ...
  it('should return true when passed a string', () => {
    ['foo'].forEach(v => expect(isString(v)).toBeTrue());
  });
...
describe('isNumber', () => {
  ...
  it('should return true when passed a number', () => {
    [1, 0, -20, 4.56].forEach(v => expect(isNumber(v)).toBeTrue());
  });
  it('should return false when passed anything else', () => {
    [
      null,
...
describe('isInt', () => {
  ...
  it('should return true when passed an int', () => {
    [1, 0, -20].forEach(v => expect(isInt(v)).toBeTrue());
  });
  it('should return false when passed anything else', () => {
    [
      null,
...
describe('isFloat', () => {
  ...
  it('should return true when passed a floating-point number', () => {
    [4.56].forEach(v => expect(isFloat(v)).toBeTrue());
  });
  it('should return false when passed anything else', () => {
    [
      null,
...
describe('isArray', () => {
  ...
  it('should return true when passed an array', () => {
    [[], [null], ['abc', 9, undefined]].forEach(v => expect(isArray(v)).toBeTrue());
  });
  it('should return false when passed anything else', () => {
    [
      null,
...
describe('isEmpty', () => {
  ...
  it('should return false when passed anything else', () => {
    ['foo', [null], ['abc', 9, undefined], { id: 4 }, /^.c+$/g].forEach(v => expect(isEmpty(v)).toBeFalse());
  });
});
describe('isClassDeclaration', () => {
  ...
  it('should return true when passed a class declaration', () => {
    [class {}].forEach(v => expect(isClassDeclaration(v)).toBeTrue());
  });
  it('should return false when passed anything else', () => {
    [
      null,
...
describe('isInstanceOf', () => {
  ...
  it('should return true when passed a constructed object an its parent class', () => {
    ...
    ).forEach(v => expect(isInstanceOf(v[0], v[1])).toBeTrue());
  });
...
describe('isPromise', () => {
  ...
  it('should return true when passed a promise', () => {
    [new Promise(() => {})].forEach(v => expect(isPromise(v)).toBeTrue());
  });
  it('should return false when passed anything else', () => {
    [
      null,
...
describe('isFunction', () => {
  ...
  it('should return true when passed a function', () => {
    [() => {}, Math.min, Date, class {}].forEach(v => expect(isFunction(v)).toBeTrue());
  });
  it('should return false when passed anything else', () => {
    [
      null,
...
describe('isRegExp', () => {
  ...
  it('should return true when passed any regular expression', () => {
    [/^.c+$/g, new RegExp('#[0-9a-f]{6}', 'im')].forEach(v => expect(isRegExp(v)).toBeTrue());
  });
  it('should return false when passed anything else', () => {
    [
      null,
...
describe('hasProp', () => {
  ...
  it('should return true when passed an object and one of its property names', () => {
    ([[{ id: 4 }, 'id']] as [any, string][]).forEach(v => expect(hasProp(v[0], v[1])).toBeTrue());
  });
  it("should return false when passed an object and a property name it doesn't have", () => {
    ...
    ).forEach(v => expect(hasProp(v[0], v[1])).toBeFalse());
  });
});
describe('evaluate', () => {
  it('should be defined', () => {
  ...
  it('should return false when passed anything else', () => {
    [null, undefined, false, 0, '', 'foo', [], {}].forEach(v => expect(evaluate(v)).toBeFalse());
  });
});
describe('all', () => {
  it('should be defined', () => {
  ...
  it('should return true when passed an array of defined values', () => {
    expect(all([true, false, 1, 0, -20, 4.56, '', 'foo'], isDefined)).toBeTrue();
  });
...
describe('most', () => {
  ...
  it('should return true when passed an array of mostly defined values', () => {
    expect(most([true, false, undefined, 1, 0, -20, null, 4.56, '', 'foo'], isDefined)).toBeTrue();
  });
  it('should return false when passed an array containing mostly undefined values', () => {
    expect(most([undefined, 1, null, null, 0, Date, undefined, null], isDefined)).toBeFalse();
  });
});
describe('any', () => {
  it('should be defined', () => {
  ...
  it('should return true when passed an array containing at least one defined value', () => {
    expect(
      any([undefined, 1, undefined, null, undefined, null, 'foo', undefined, undefined, undefined, null], isDefined)
    ).toBeTrue();
  });
  it('should return false when passed an array containing only undefined values', () => {
    expect(any([undefined, null, null, undefined, null], isDefined)).toBeFalse();
  });
});
describe('none', () => {
  it('should be defined', () => {
  ...
  it('should return true when passed an array containing only undefined values', () => {
    expect(
      none([undefined, undefined, null, undefined, null, undefined, undefined, undefined, null], isDefined)
    ).toBeTrue();
  });
  it('should return false when passed an array containing at least one defined values', () => {
    expect(none([undefined, null, Math.min, null, undefined, null], isDefined)).toBeFalse();
  });
});
describe('some', () => {
  it('should be defined', () => {
  ...
  it('should return true when passed an array containing at least 40% defined values', () => {
    expect(some([undefined, null, 5, undefined, 'foo', null, [], Math.min, class {}], 0.4, isDefined)).toBeTrue();
  });
